...
function EventCard({ eventId }: { eventId: Id<"events"> }) {
    ...
    const renderTicketStatus = () => {
        ...
        if (userTicket) {
            return (
                <div className="mt-4 flex items-center justify-between bg-green-50 rounded-lg border border-green-100 p-3">
                    <div className="flex items-center">
                        <CheckCheck className="w-5 h-5 text-green-600 mr-2" />
        ...
        >
            ...
            <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
                <div className="flex justify-between items-start">
                    ...
                    <div>
                        <div className="flex flex-col items-start gap-2">
                            {isEventOwner && (
                                <span className="inline-flex items-center gap-1 bg-blue-600/90 text-white mb-2 px-2 py-1 rounded-full text-xs font-medium">
                                    <StarIcon className="w-3 h-3" /> Your Event
                                </span>
                            )}
                        </div>
                ...
                <div className="flex flex-col items-end gap-2 ml-4">
                    <span
                        className={`px-4 py-1.5 font-semibold text-sm rounded-full ${isPastEvent
