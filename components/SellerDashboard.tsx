...
import { createStripeConnectLoginLinks } from '@/actions/createStripeConnectLoginLinks';
import { AccountStatus, getStripeConnectAccountStatus } from '@/actions/getStripeConnectStatus';
    ...
    const handleManageAccount = async () => {
        try {
            if (stripeConnectId && accountStatus?.isActive) {
                const loginUrl = await createStripeConnectLoginLinks(stripeConnectId)
                    ...
                    <>
                        <div className="bg-white p-8 rounded-lg">
                            ...
                            <p className="mb-8 text-gray-600">
                                List your tickets for sales and manage your listings
                            </p>
                    ...
                    {!stripeConnectId && !accountCreatePending && (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Create your seller account to start accepting payment <i>securely</i> through <span className='uppercase font-bold text-blue-500'>stripe</span>
                            </p>
                            <button
                                onClick={async () => {
                        ...
                        <div className="space-y-6">
                            ...
                            {accountStatus.requiresInformation && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                    ...
                                    {!accountCreatePending && (
                                        ...
                                        >
                                            {accountLinkCreatePending ? "Loading..." : "Complete Requirements"}
                                        </button>)}
                                </div>
                            )}
                            ...
                            {error && (
                                <div className="mt-4 bg-red-50 text-red-600 p-3 rounded-lg">
                                    Unable to access stripe dashboard. Please complete all requirements.
                                </div>
                            )}
